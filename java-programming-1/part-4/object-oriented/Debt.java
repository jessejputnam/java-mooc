 ...
 * The balance and the interest rate are passed to the constructor as parameters public 
 ...
 * for the class. The method printBalance prints the current balance, and the waitOneYear 
 * method grows the debt amount.
 * 
